...
for cell in notebook['cells']:
    if cell['cell_type'] == 'code' and cell['source'] and '# Now try importing the modules' in ''.join(cell['source']):
        # Update the source with final version reflecting installed modules and model
        new_source = [
            ...
            "    print(\"Please install pyaudio and vosk packages.\")\n",
            "\n",
...
print("Notebook updated successfully with final speech recognition test cell.")
